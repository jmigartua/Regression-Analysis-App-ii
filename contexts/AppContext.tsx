...
const translations: { [key in Language]: any } = {
  en: {
    ...
    "main.select_vars_title": "Visualize Your Data",
    "main.select_vars_description": "Select an independent (X) and dependent (Y) variable in the explorer panel to generate a scatter plot.",
    ...
    "plot.hide_line": "Hide Line",
    "plot.show_line": "Show Line",
  ...
  es: {
    ...
    "main.select_vars_title": "Visualiza Tus Datos",
    "main.select_vars_description": "Selecciona una variable independiente (X) y dependiente (Y) en el panel explorador para generar un gráfico de dispersión.",
    ...
    "plot.hide_line": "Ocultar Línea",
    "plot.show_line": "Mostrar Línea",
  ...
  eu: {
    ...
    "main.select_vars_title": "Ikusi Zure Datuak",
    "main.select_vars_description": "Hautatu aldagai aske bat (X) eta mendeko bat (Y) esploratzaile panelean sakabanatze-diagrama bat sortzeko.",
    ...
    "plot.hide_line": "Ezkutatu Lerroa",
    "plot.show_line": "Erakutsi Lerroa",
