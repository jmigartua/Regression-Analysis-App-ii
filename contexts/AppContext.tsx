...
const translations: { [key in Language]: any } = {
  en: {
    ...
    "plot.controls_title": "Plot Controls",
    ...
    "analysis.fitting_options_title": "Fitting Options",
    "analysis.fitting_options_placeholder": "Higher-order fitting models will be available here in future updates.",
  ...
  es: {
    ...
    "plot.controls_title": "Controles del Gráfico",
    ...
    "analysis.fitting_options_title": "Opciones de Ajuste",
    "analysis.fitting_options_placeholder": "Modelos de ajuste de orden superior estarán disponibles aquí en futuras actualizaciones.",
  ...
  eu: {
    ...
    "plot.controls_title": "Grafikoaren Kontrolak",
    ...
    "analysis.fitting_options_title": "Doikuntza Aukerak",
    "analysis.fitting_options_placeholder": "Goi-mailako doikuntza ereduak hemen egongo dira eskuragarri etorkizuneko eguneraketetan.",
